...
| `standard_link` | `page` | `<link rel="site.standard.document">` from `page.data.atproto_uri` — the standard.site per-page proof; empty until you've [published](../guides/publishing-atproto.md). |
