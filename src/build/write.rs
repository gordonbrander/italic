...
/// [`redirect::run`](super::redirect::run)) into `output_dir`, creating parent
/// directories as needed.
///
/// Two outputs claiming the same `output_path` is a misconfiguration (clashing
/// `permalink`s, or a redirect shadowing a real page). The **first** writer of a
...
/// point. Because the pipeline appends redirect stubs after all real pages, a
