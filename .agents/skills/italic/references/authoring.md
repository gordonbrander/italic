...
Within this markup phase a template sees only site data and the page it's
...
another note's body (see
[Differences from Obsidian](wikilinks.md#differences-from-obsidian)).
