# Italic documentation

[Italic](https://github.com/gordonbrander/italic) is a static site generator
for digital gardens. These docs cover everything from a five-minute quickstart
to a complete reference of every config key and template filter.
...
- [Authoring content](guides/authoring.md)
- [Wikilinks & backlinks](guides/wikilinks.md)
- [Related pages](guides/related.md)
- [Collections](guides/collections.md)
- [Taxonomies & hashtags](guides/taxonomies.md)
- [Templates](guides/templates.md)
- [Components (shortcodes)](guides/components.md)
