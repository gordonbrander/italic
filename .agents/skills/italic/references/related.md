...
This page covers the `related` filter: how relatedness is scored, the
`related.weights` config, and its kwargs. It works with zero configuration and
gets sharper as you add tags and links.
...
[template reference](doc-list-filters.md#related--pages-related-to-this-page).
...
- [Configuration reference: related](config.md#related)
